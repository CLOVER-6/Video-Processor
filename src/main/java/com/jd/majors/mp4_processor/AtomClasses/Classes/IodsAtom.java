...
public class IodsAtom implements FullAtom, NestedAtom
{
    ...
    public IodsAtom(GeneralAtom parentAtom, int s, String n, short version, byte[] f, byte[] payload) 
    {
    ...
    {
        return "IodsAtom [size=" + size + ", name=" + name + ", version=" + version +
    ...
    public boolean equals(Object obj) 
    {
        ...
        if (!(obj instanceof IodsAtom)) return false;
        IodsAtom other = (IodsAtom) obj;
