...
public class DinfAtom implements ContainerAtom 
{
    private final int size;
    private final String name;
    private final List<GeneralAtom> childBoxes;

    public DinfAtom(int size, String name, List<GeneralAtom> childBoxes) 
    {
        this.size = size;
        this.name = name;
    ...
    {
        return "DinfAtom [size=" + size + ", name=" + name + ", childBoxes=" + childBoxes + "]";
    }
