...
public class StscAtom implements FullAtom, NestedAtom
{
    ...
    public StscAtom(GeneralAtom parentAtom, int s, String n, short version, byte[] f, byte[] payload) 
    {
    ...
    {
        return "StscAtom [size=" + size + ", name=" + name + ", version=" + version +
    ...
    {   	
        ...
        if (!(obj instanceof StscAtom)) return false;
