...
public class Mp4File
{
	...
	private Box createAtom(long offset) throws IOException
	{
		...
		// must use ISO-8859-1 because each byte maps directly to a character
		// utf-8's use of code unit and variable character length causes issues with non-ascii characters
